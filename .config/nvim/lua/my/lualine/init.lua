...
local my_theme = {
    ...
    normal = {
        ...
        b = { fg = colors.base07, bg = colors.base00 },
        c = { fg = colors.base07, bg = colors.base02 },
        z = { fg = colors.base07, bg = colors.base00 },
    },
}
...
require('lualine').setup {
    ...
    sections = {
        ...
        lualine_z = {
            ...
            { 'branch',
                icon = { icons.git, color = { bg = colors.base00, gui = "bold" } }
            },
            utils.createSpaceComponent(colors.base04),
        },
    },
