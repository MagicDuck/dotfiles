...
vim.api.nvim_create_autocmd('BufUnload', {
  group = vim.api.nvim_create_augroup('my-grug-far-unload', { clear = true }),
  pattern = { 'grug-far' },
  callback = function()
    vim.cmd('stopinsert')
  end,
  ...
  callback = function(ev)
    ...
    if value.kind == 'begin' then
      ...
      local progress = {
        ...
        source = 'my-lsp-progress-indicator',
      }
    ...
    local progress = lsp_progress[client_id] and lsp_progress[client_id][token]
